      ...
      <div>
        <div className="navbar-fixed" style={{ display: "flex", justifyContent: "center", flexDirection: "column", height: "20vh" }}>
          <div className='top-next'>
            <div>
              <svg onClick={toggleSearchMenu} style={{width:"25px"}} xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
              ...
              {localStorage.getItem('authToken') && (
                <div>
                  <Link to='/cart' className="cart-link">
                    <svg xmlns="http://www.w3.org/2000/svg" style={{width:"25px"}} width="24" height="24" fill="black" className="bi bi-bag" viewBox="0 0 16 16">
