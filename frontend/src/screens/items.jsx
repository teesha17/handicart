...
export default function items() {
  ...
  return (
    <div style={{"backgroundColor":"black"}}>
      ...
      <div style={{ "height": "50vh" ,"backgroundImage":"url('https://www.hdwallpapers.in/download/wet_brown_leaves_hd_dark_aesthetic-1920x1080.jpg')","backgroundRepeat":"no-repeat","backgroundSize":"cover"}}>
      <div class="px-4 py-5 my-0 text-center">
        
        <div class="col-lg-6 mx-auto">
          <h2 class=" mb-4" style={{color:"white"}}>Build a home you just can't wait getting back to</h2>
          <p>Express Your Style and Create a Home that Reflects your Aesthetics</p>
        </div>
        <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
          <button type="button" class="btn btn-info btn-text-primary btn-lg px-4">SHOP NOW</button>
        </div>
